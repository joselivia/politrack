...
export function HeroSection() {
  return (
    <section className="relative py-14 lg:py-24 overflow-hidden bg-gradient-to-br from-background via-muted/20 to-background">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              <h1 className="text-5xl lg:text-6xl xl:text-7xl font-black text-balance leading-tight tracking-tight">
                Decoding
              ...
              <p className="text-xl lg:text-2xl text-muted-foreground font-medium text-pretty leading-relaxed">
                Data-Driven Insights for Political &amp; Socio-Economic Strategy
              </p>
            </div>

            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl border-l-4 border-accent pl-6 py-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                className="text-lg px-8 py-6 bg-accent hover:bg-accent/90 text-accent-foreground font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="text-lg px-8 py-6 border-2 border-primary/20 text-foreground hover:bg-primary hover:text-primary-foreground font-semibold bg-background/80 backdrop-blur-sm transition-all duration-300"
              >
                Get In Touch
              </Button>
            </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="p-8 border border-border/50 shadow-2xl hover:shadow-2xl transition-all duration-300 bg-card/80 backdrop-blur-sm rounded-3xl">
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center text-sm font-semibold text-accent-foreground bg-accent/20 px-4 py-2 rounded-full">
            ...
            <Card className="p-8 border border-border/50 shadow-2xl hover:shadow-2xl transition-all duration-300 bg-card/80 backdrop-blur-sm rounded-3xl">
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center text-sm font-semibold text-muted-foreground bg-muted/50 px-4 py-2 rounded-full">
