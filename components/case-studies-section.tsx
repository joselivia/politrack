...
const caseStudies = [
  {
    ...
    location: "Nigeria",
    challenge: "Client trailed by 15 points 6 months pre‑election with low engagement in key swing states.",
    solution:
      "Identified unaddressed grievances in 3 swing states via granular sentiment mapping and targeted grassroots strategy.",
    outcome: "Data‑driven grassroots strategy led to 8‑point swing and victory.",
    metrics: [
  ...
  },
  {
    ...
    location: "Rwanda",
    challenge: "Government sought evidence to strengthen women's land rights with traditional leader resistance.",
    solution: "Nationwide perception study + traditional leader engagement analysis to build consensus.",
    outcome: "Informed legislation passed with 76% public support and broad stakeholder buy-in.",
    metrics: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
            Real results from our data-driven approach to political and policy challenges across Africa, demonstrating
            measurable impact and strategic success.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {caseStudies.map((study, index) => (
            <Card
              key={index}
              className="group hover:shadow-xl transition-all duration-300 border-0 bg-card/80 backdrop-blur"
            >
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-sm text-muted-foreground mb-2">OUR ROLE</h4>
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed font-medium text-foreground">{study.outcome}</p>
                  </div>
                </div>
